...
manifest to the top-level tag. GitHub's web user interface at
https://github.com/csjewell/atuin-tiny/pkgs/container/atuin-tiny
...
You can see attestations at https://github.com/csjewell/atuin-tiny/attestations,
but ultimately, you can check them on the command line.
